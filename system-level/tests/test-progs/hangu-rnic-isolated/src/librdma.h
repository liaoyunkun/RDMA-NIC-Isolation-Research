...
#define TEST_CQ_NUM 1
#define TEST_WR_NUM 10
#define LATENCY_WR_NUM 1

#define LS_BS   1
#define ITER_LS   10000
#define ITER_BS   10000
#define MSG_SIZE_LS 64
#define MSG_SIZE_BS   4 * 4096
#define BS0_MSG_SIZE   32 * 4096
#define BS1_MSG_SIZE   1024 * 4096
#define LS_CPU_ID 0
#define BS_CPU_ID 1
#define BS0_CPU_ID 0
#define BS1_CPU_ID 1
#define BS_INIT_BATCH 1
